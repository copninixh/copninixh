        ...
        <>
            <div className='container mx-auto px-8 md:px-20 hidden sm:block xl:block lg:block md:block'>
                <div className='columns-1 justify-center mt-[100px] mb-[100px]'>
                    ...
                    <p className='text-center text-gray-custom dark:text-[#94a3b8]'>It stands the test of time, it’s never weak, never brief</p>
                    <div className="flex justify-center mt-4">
                        <Button variant="filled" className='bg-[#192635] dark:bg-[#003D7C] button-color button-text'><i className="fal fa-file-alt"></i>&nbsp; My SOP</Button>
                    </div>
                    ...
                    <div className="relative mt-5 text-justify">
                        ...
                        {!showMore && (
                            <div
                            className="text-center bg-gradient-to-b from-white to-white dark:from-[#121212] dark:to-[#121212]"
                            
                            >
                            <button
                                onClick={() => setShowMore(true)}
                                className="px-4  border-2 border-gray-800 dark:border-white rounded-[20px] mt-2"
                            >
                                Read More
                            </button>
                            </div>
            ...
            <div className='container mx-auto px-8 md:px-20 block sm:hidden xl:hidden lg:hidden md:hidden'>
                <div className='columns-1 justify-center mt-[100px] mb-[100px]'>
                    <h4 className="text-center font-bold text-2xl">Statement of Purpose</h4>
                    <p className='text-center text-gray-custom dark:text-[#94a3b8]'>It stands the test of time, it’s never weak, never brief</p>
                    <div className="flex justify-center mt-4">
