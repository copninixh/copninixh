        ...
        <>
            <div className="container mx-auto px-8 md:px-16">
                <div className='columns-1 justify-center mt-[100px]'>
                    ...
                    <p className='text-center text-gray-custom dark:text-[#94a3b8]'>My passionate about Technology</p>
                

                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 justify-center mt-10">
                        <div className="w-full rounded-[20px] border-2 border-gray-800 dark:border-[#94a3b8] lg:px-16 pt-16 pb-16 text-center">
